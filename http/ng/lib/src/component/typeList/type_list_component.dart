...
class TypeListComponent implements OnInit, OnActivate {
  ...
  TypeListComponent(this._router);
  ...
  void onActivate(_, RouterState current) async {
    ...
    // Get current path from router parameters
  ...
  // TODO - Migrate to new parameter architecture, load components
