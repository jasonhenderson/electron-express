...
@Component(
    ...
    providers: [
      Provider(HasDisabled, useExisting: RaisableMenuComponent),
    ],
    templateUrl: 'raisable_menu_component.html',
    changeDetection: ChangeDetectionStrategy.OnPush)
class RaisableMenuComponent extends Object
  ...
  RaisableMenuComponent(this._root);
  ...
  /// Whether the menu is a raised button or not
  @Input()
  bool raised = false;
